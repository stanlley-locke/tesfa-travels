...
export default function AboutPage() {
  const values = [
    {
      icon: Award,
      title: 'IATA Certified & Regulated',
      description: 'Globally recognized accreditation ensuring the highest standards of financial and professional competence.'
    },
    {
      icon: ShieldCheck,
      title: 'Competitive Market Rates',
      description: 'Direct access to global GDS networks guarantees optimal pricing and exclusive negotiated fares.'
    },
    {
      icon: Users,
      title: 'Expert Travel Consultants',
      description: 'A dedicated team of industry veterans crafting meticulous itineraries tailored to precise specifications.'
    },
    {
      icon: Headset,
      title: '24/7 Customer Support',
      description: 'Unwavering global assistance around the clock, providing peace of mind wherever you land.'
    },
    {
      icon: CreditCard,
      title: 'Multiple Payment Options',
      description: 'Secure, flexible, and diversified corporate and personal payment gateways across major global currencies.'
    },
    {
      icon: Briefcase,
      title: 'Corporate Account Services',
      description: 'Bespoke corporate travel management designed to streamline business operations and maximize efficiency.'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-sm md:text-base text-neutral-600 leading-relaxed max-w-lg">
                <p>
                  Since our inception, Tesfa Travels has redefined the standard for premium travel management. As a fully IATA-accredited agency with over a decade of operational excellence, we have cultivated a legacy anchored in absolute reliability and meticulous attention to detail.
                </p>
                <p>
                  Whether navigating complex corporate travel logistics, securing specialized visa clearances, or orchestrating bespoke luxury expeditions, our approach remains fiercely uncompromising: we deliver global access with localized precision. 
                </p>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="relative h-[500px] w-full bg-neutral-100 overflow-hidden"
            >
              <div className="absolute inset-0 bg-[#6b7b65]/10 z-10" />
              {/* Optional: Add an image here if available, using a placeholder gradient for now */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10 border border-white/10">
              {values.map((value, idx) => (
                <motion.div
                  ...
                  className="bg-[#111111] p-12 hover:bg-[#1a1a1a] transition-colors group"
                >
